		...
		<section>
			<div class="child-page-listing" style="margin-top: 20px">
				<div class="grid-container">
					...
					if($cNum==1) {
						$query = "select movie.movienum, movie.movietitle from movie, moviegenre 
						where movie.movienum = moviegenre.MovieNum and movie.ProductionCountry = ".$cNum." and moviegenre.GenreNum = ".$gNum.";";
					} else{
						$query = "select movie.movienum, movie.movietitle from movie, moviegenre 
						where movie.movienum = moviegenre.MovieNum and movie.ProductionCountry >= ".$cNum." and moviegenre.GenreNum = ".$gNum.";";
					}
